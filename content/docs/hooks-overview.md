...
functional components ലേക് state ഉം lifecycle hooks ഉം തരുന്ന സവിശേഷതകൾ ചേർക്കാൻ സഹായിക്കുന്ന ഒരു ഫീച്ചർ ആണ് Hooks. functions നു ഉള്ളിൽ മാത്രമേ ഹൂക്സ് ഉപയോഗിക്കാൻ ആവുക ഉള്ളു. (നിങ്ങൾ ഇപ്പോൾ ഉള്ള components മാറ്റി എഴുതുന്നതിനു പകരം പുതിയ components ൽ Hooks ഉപയോഗികിച്ചു തുടങ്ങണം എന്നാണ് [ഞങ്ങൾ നിർദ്ദേശിക്കുന്നത്](/docs/hooks-intro.html#gradual-adoption-strategy))
...
>വിശദീകരണം
>
>State Hook നെ പറ്റി കൂടുതൽ വിശദം ആയി പഠിക്കാൻ ഈ പേജ് നോക്കുക : [Using the State Hook](/docs/hooks-state.html).
